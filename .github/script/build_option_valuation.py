...
def get_option_data(config, option_star_folder_path, option_hold_folder_path):
    try:
        ...
        os.system("python ./.github/script/Norn-Finance-API-Server/option_cron_job.py -i " + star_list_str + " -l ERROR")
        ...
        os.system("python ./.github/script/Norn-Finance-API-Server/option_cron_job.py -s " + ",".join(specific_contracts) + " -l ERROR")
