...
var entry = require('../entry-6649b0d5.js');
...
var debugCtor = _interopDefault(require('debug'));
var Queue = _interopDefault(require('better-queue'));
var mitt = _interopDefault(require('mitt'));
var standalone = _interopDefault(require('@babel/standalone'));
...
var remarkMdxjs = _interopDefault(require('remark-mdxjs'));
var visit = _interopDefault(require('unist-util-visit'));
var styleToObject = _interopDefault(require('style-to-object'));
...
var aa=entry.objectAssign,ba=entry.react,m=scheduler;function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var p=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
const render = (recipe, cb, context = {}, isApply, isStream, name) => {
  ...
  const throttledRenderResources = _.throttle(renderResources, 100);
...
var proto$2 = Schema$1.prototype;
proto$2.space = null;
proto$2.normal = {};
proto$2.property = {};

function Schema$1(property, normal, space) {
  this.property = property;
  this.normal = normal;
...
var info$1 = Info$1;
var proto$3 = Info$1.prototype;
proto$3.space = null;
proto$3.attribute = null;
proto$3.property = null;
proto$3.boolean = false;
proto$3.booleanish = false;
proto$3.overloadedBoolean = false;
proto$3.number = false;
proto$3.commaSeparated = false;
proto$3.spaceSeparated = false;
proto$3.commaOrSpaceSeparated = false;
proto$3.mustUseProperty = false;
proto$3.defined = false;
...
var powers$1 = 0;
var boolean_1$1 = increment$1();
var booleanish$3 = increment$1();
var overloadedBoolean$2 = increment$1();
var number$4 = increment$1();
var spaceSeparated$4 = increment$1();
var commaSeparated$3 = increment$1();
var commaOrSpaceSeparated$2 = increment$1();
...
var types$1 = {
	...
	number: number$4,
	spaceSeparated: spaceSeparated$4,
	commaSeparated: commaSeparated$3,
	commaOrSpaceSeparated: commaOrSpaceSeparated$2
};

var definedInfo$1 = DefinedInfo$1;
DefinedInfo$1.prototype = new info$1();
DefinedInfo$1.prototype.defined = true;
var checks$1 = ['boolean', 'booleanish', 'overloadedBoolean', 'number', 'commaSeparated', 'spaceSeparated', 'commaOrSpaceSeparated'];
var checksLength$1 = checks$1.length;
...
function DefinedInfo$1(property, attribute, mask, space) {
  ...
  while (++index < checksLength$1) {
    check = checks$1[index];
    mark$1(this, check, (mask & types$1[check]) === types$1[check]);
  }
}
...
var caseSensitiveTransform_1$1 = caseSensitiveTransform$1;

function caseSensitiveTransform$1(attributes, attribute) {
  return attribute in attributes ? attributes[attribute] : attribute;
}

var caseInsensitiveTransform_1$1 = caseInsensitiveTransform$1;

function caseInsensitiveTransform$1(attributes, property) {
  return caseSensitiveTransform_1$1(attributes, property.toLowerCase());
}

var xmlns$2 = create_1$1({
  space: 'xmlns',
  attributes: {
    xmlnsxlink: 'xmlns:xlink'
  },
  transform: caseInsensitiveTransform_1$1,
  properties: {
    xmlns: null,
    xmlnsXLink: null
  }
...
var booleanish$4 = types$1.booleanish;
var number$5 = types$1.number;
var spaceSeparated$5 = types$1.spaceSeparated;
var aria$1 = create_1$1({
  transform: ariaTransform$1,
  properties: {
    ariaActiveDescendant: null,
    ariaAtomic: booleanish$4,
    ariaAutoComplete: null,
    ariaBusy: booleanish$4,
    ariaChecked: booleanish$4,
    ariaColCount: number$5,
    ariaColIndex: number$5,
    ariaColSpan: number$5,
    ariaControls: spaceSeparated$5,
    ariaCurrent: null,
    ariaDescribedBy: spaceSeparated$5,
    ariaDetails: null,
    ariaDisabled: booleanish$4,
    ariaDropEffect: spaceSeparated$5,
    ariaErrorMessage: null,
    ariaExpanded: booleanish$4,
    ariaFlowTo: spaceSeparated$5,
    ariaGrabbed: booleanish$4,
    ariaHasPopup: null,
    ariaHidden: booleanish$4,
    ariaInvalid: null,
    ariaKeyShortcuts: null,
    ariaLabel: null,
    ariaLabelledBy: spaceSeparated$5,
    ariaLevel: number$5,
    ariaLive: null,
    ariaModal: booleanish$4,
    ariaMultiLine: booleanish$4,
    ariaMultiSelectable: booleanish$4,
    ariaOrientation: null,
    ariaOwns: spaceSeparated$5,
    ariaPlaceholder: null,
    ariaPosInSet: number$5,
    ariaPressed: booleanish$4,
    ariaReadOnly: booleanish$4,
    ariaRelevant: null,
    ariaRequired: booleanish$4,
    ariaRoleDescription: spaceSeparated$5,
    ariaRowCount: number$5,
    ariaRowIndex: number$5,
    ariaRowSpan: number$5,
    ariaSelected: booleanish$4,
    ariaSetSize: number$5,
    ariaSort: null,
    ariaValueMax: number$5,
    ariaValueMin: number$5,
    ariaValueNow: number$5,
    ariaValueText: null,
    role: null
  }
});
...
var boolean$2 = types$1.boolean;
var number$6 = types$1.number;
var spaceSeparated$6 = types$1.spaceSeparated;
var commaSeparated$4 = types$1.commaSeparated;
var commaOrSpaceSeparated$3 = types$1.commaOrSpaceSeparated;
var svg$2 = create_1$1({
  space: 'svg',
  attributes: {
    accentHeight: 'accent-height',
    alignmentBaseline: 'alignment-baseline',
  ...
  transform: caseSensitiveTransform_1$1,
  properties: {
    about: commaOrSpaceSeparated$3,
    accentHeight: number$6,
    accumulate: null,
    additive: null,
    alignmentBaseline: null,
    alphabetic: number$6,
    ...
    hrefLang: null,
    horizAdvX: number$6,
    horizOriginX: number$6,
    horizOriginY: number$6,
    id: null,
    ideographic: number$6,
    imageRendering: null,
    initialVisibility: null,
    in: null,
    in2: null,
    ...
    overflow: null,
    overlay: null,
    overlinePosition: number$6,
    overlineThickness: number$6,
    paintOrder: null,
    panose1: null,
    path: null,
    pathLength: number$6,
    ...
    slope: null,
    snapshotTime: null,
    specularConstant: number$6,
    specularExponent: number$6,
    spreadMethod: null,
    spacing: null,
    startOffset: null,
    stdDeviation: null,
    ...
    stopColor: null,
    stopOpacity: null,
    strikethroughPosition: number$6,
    strikethroughThickness: number$6,
    string: null,
    stroke: null,
    ...
    strokeLineCap: null,
    strokeLineJoin: null,
    strokeMiterLimit: number$6,
    strokeOpacity: number$6,
    strokeWidth: null,
    style: null,
    surfaceScale: number$6,
    syncBehavior: null,
    syncBehaviorDefault: null,
    syncMaster: null,
    syncTolerance: null,
    ...
    u1: null,
    u2: null,
    underlinePosition: number$6,
    underlineThickness: number$6,
    unicode: null,
    unicodeBidi: null,
    unicodeRange: null,
    unitsPerEm: number$6,
    values: null,
    vAlphabetic: number$6,
    vMathematical: number$6,
    vectorEffect: null,
    vHanging: number$6,
    vIdeographic: number$6,
    version: null,
    vertAdvY: number$6,
    vertOriginX: number$6,
    vertOriginY: number$6,
    viewBox: null,
    viewTarget: null,
    visibility: null,
    width: null,
...
var svg_1$1 = merge_1$1([xml$2, xlink$2, xmlns$2, aria$1, svg$2]);
...
var svgCaseSensitiveTagNames$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
function find$1(schema, value) {
  ...
  if (normal.length > 4 && normal.slice(0, 4) === data$1 && valid$1.test(value)) {
    // Attribute or property.
    if (value.charAt(4) === '-') {
...
function parsePrimitive(info, name, value) {
  ...
  if (info.number || info.positiveNumber) {
    ...
    if (typeof result === 'string' && (result === '' || normalize_1$1(value) === normalize_1$1(name))) {
      result = true;
    }
  }
...
var caseSensitive = entry.getCjsExportFromNamespace(svgCaseSensitiveTagNames$1);

var svg$3 = factory_1(svg_1$1, 'g', caseSensitive);
svg$3.displayName = 'svg';
var svg_1$2 = svg$3;

var boolean$3 = types$1.boolean;
var overloadedBoolean$3 = types$1.overloadedBoolean;
var booleanish$5 = types$1.booleanish;
var number$7 = types$1.number;
var spaceSeparated$7 = types$1.spaceSeparated;
var commaSeparated$5 = types$1.commaSeparated;
var html$3 = create_1$1({
  space: 'html',
  attributes: {
    acceptcharset: 'accept-charset',
    classname: 'class',
  ...
  properties: {
    // Standard Properties.
    abbr: null,
    accept: commaSeparated$5,
    acceptCharset: spaceSeparated$7,
    accessKey: spaceSeparated$7,
    action: null,
    allow: null,
    ...
    checked: boolean$3,
    cite: null,
    className: spaceSeparated$7,
    cols: number$7,
    colSpan: null,
    content: null,
    contentEditable: booleanish$5,
    controls: boolean$3,
    controlsList: spaceSeparated$7,
    coords: number$7 | commaSeparated$5,
    crossOrigin: null,
    data: null,
    dateTime: null,
    decoding: null,
    ...
    formTarget: null,
    headers: spaceSeparated$7,
    height: number$7,
    hidden: boolean$3,
    high: number$7,
    href: null,
    hrefLang: null,
    htmlFor: spaceSeparated$7,
    httpEquiv: spaceSeparated$7,
    id: null,
    imageSizes: null,
    imageSrcSet: commaSeparated$5,
    inputMode: null,
    integrity: null,
    is: null,
    isMap: boolean$3,
    itemId: null,
    itemProp: spaceSeparated$7,
    itemRef: spaceSeparated$7,
    itemScope: boolean$3,
    itemType: spaceSeparated$7,
    kind: null,
    label: null,
    lang: null,
    language: null,
    ...
    readOnly: boolean$3,
    referrerPolicy: null,
    rel: spaceSeparated$7,
    required: boolean$3,
    reversed: boolean$3,
    rows: number$7,
    rowSpan: number$7,
    sandbox: spaceSeparated$7,
    scope: null,
    scoped: boolean$3,
    seamless: boolean$3,
    selected: boolean$3,
    ...
    slot: null,
    span: number$7,
    spellCheck: booleanish$5,
    src: null,
    srcDoc: null,
    srcLang: null,
    srcSet: commaSeparated$5,
    start: number$7,
    step: null,
    style: null,
    tabIndex: number$7,
    ...
    lowSrc: null,
    // `<img>`. Use a `<picture>`
    marginHeight: number$7,
    // `<body>`
    marginWidth: number$7,
    // `<body>`
    noResize: boolean$3,
    // `<frame>`
    noHref: boolean$3,
...
var html_1$1 = merge_1$1([xml$2, xlink$2, xmlns$2, aria$1, html$3]);

var html$4 = factory_1(html_1$1, 'div');
...
var ns = entry.getCjsExportFromNamespace(webNamespaces);
...
function element(ast, children, config) {
  var fn = config.schema.space === 'svg' ? svg_1$2 : hastscript;
...
var proto$4 = Schema$2.prototype;
proto$4.space = null;
proto$4.normal = {};
proto$4.property = {};
...
function merge$2(definitions) {
  ...
  return new schema$2(immutable.apply(null, property), immutable.apply(null, normal), space);
}
...
var powers$2 = 0;
var boolean_1$2 = increment$2();
var booleanish$6 = increment$2();
var overloadedBoolean$4 = increment$2();
var number$8 = increment$2();
var spaceSeparated$8 = increment$2();
var commaSeparated$6 = increment$2();
var commaOrSpaceSeparated$4 = increment$2();

function increment$2() {
  return Math.pow(2, ++powers$2);
}

var types$2 = {
	boolean: boolean_1$2,
	booleanish: booleanish$6,
	overloadedBoolean: overloadedBoolean$4,
	number: number$8,
	spaceSeparated: spaceSeparated$8,
	commaSeparated: commaSeparated$6,
	commaOrSpaceSeparated: commaOrSpaceSeparated$4
};

var definedInfo$2 = DefinedInfo$2;
DefinedInfo$2.prototype = new info$2();
DefinedInfo$2.prototype.defined = true;
var checks$2 = ['boolean', 'booleanish', 'overloadedBoolean', 'number', 'commaSeparated', 'spaceSeparated', 'commaOrSpaceSeparated'];
var checksLength$2 = checks$2.length;
...
function DefinedInfo$2(property, attribute, mask, space) {
  ...
  while (++index < checksLength$2) {
    check = checks$2[index];
    mark$2(this, check, (mask & types$2[check]) === types$2[check]);
  }
}
...
function create$2(definition) {
  ...
  for (prop in props) {
    info = new definedInfo$2(prop, transform(attributes, prop), props[prop], space);
    ...
    property[prop] = info;
    normal[normalize_1$2(prop)] = prop;
    normal[normalize_1$2(info.attribute)] = prop;
  }

  return new schema$2(property, normal, space);
}

var xlink$3 = create_1$2({
  space: 'xlink',
...
var caseSensitiveTransform_1$2 = caseSensitiveTransform$2;

function caseSensitiveTransform$2(attributes, attribute) {
  return attribute in attributes ? attributes[attribute] : attribute;
}

var caseInsensitiveTransform_1$2 = caseInsensitiveTransform$2;

function caseInsensitiveTransform$2(attributes, property) {
  return caseSensitiveTransform_1$2(attributes, property.toLowerCase());
}

var xmlns$3 = create_1$2({
  space: 'xmlns',
  attributes: {
    xmlnsxlink: 'xmlns:xlink'
  },
  transform: caseInsensitiveTransform_1$2,
  properties: {
    xmlns: null,
    xmlnsXLink: null
  }
...
var booleanish$7 = types$2.booleanish;
var number$9 = types$2.number;
var spaceSeparated$9 = types$2.spaceSeparated;
var aria$2 = create_1$2({
  transform: ariaTransform$2,
  properties: {
    ariaActiveDescendant: null,
    ariaAtomic: booleanish$7,
    ariaAutoComplete: null,
    ariaBusy: booleanish$7,
    ariaChecked: booleanish$7,
    ariaColCount: number$9,
    ariaColIndex: number$9,
    ariaColSpan: number$9,
    ariaControls: spaceSeparated$9,
    ariaCurrent: null,
    ariaDescribedBy: spaceSeparated$9,
    ariaDetails: null,
    ariaDisabled: booleanish$7,
    ariaDropEffect: spaceSeparated$9,
    ariaErrorMessage: null,
    ariaExpanded: booleanish$7,
    ariaFlowTo: spaceSeparated$9,
    ariaGrabbed: booleanish$7,
    ariaHasPopup: null,
    ariaHidden: booleanish$7,
    ariaInvalid: null,
    ariaKeyShortcuts: null,
    ariaLabel: null,
    ariaLabelledBy: spaceSeparated$9,
    ariaLevel: number$9,
    ariaLive: null,
    ariaModal: booleanish$7,
    ariaMultiLine: booleanish$7,
    ariaMultiSelectable: booleanish$7,
    ariaOrientation: null,
    ariaOwns: spaceSeparated$9,
    ariaPlaceholder: null,
    ariaPosInSet: number$9,
    ariaPressed: booleanish$7,
    ariaReadOnly: booleanish$7,
    ariaRelevant: null,
    ariaRequired: booleanish$7,
    ariaRoleDescription: spaceSeparated$9,
    ariaRowCount: number$9,
    ariaRowIndex: number$9,
    ariaRowSpan: number$9,
    ariaSelected: booleanish$7,
    ariaSetSize: number$9,
    ariaSort: null,
    ariaValueMax: number$9,
    ariaValueMin: number$9,
    ariaValueNow: number$9,
    ariaValueText: null,
    role: null
  }
});
...
var boolean$4 = types$2.boolean;
var overloadedBoolean$5 = types$2.overloadedBoolean;
var booleanish$8 = types$2.booleanish;
var number$a = types$2.number;
var spaceSeparated$a = types$2.spaceSeparated;
var commaSeparated$7 = types$2.commaSeparated;
var html$5 = create_1$2({
  space: 'html',
  attributes: {
    acceptcharset: 'accept-charset',
    classname: 'class',
  ...
  properties: {
    // Standard Properties.
    abbr: null,
    accept: commaSeparated$7,
    acceptCharset: spaceSeparated$a,
    accessKey: spaceSeparated$a,
    action: null,
    allow: null,
    allowFullScreen: boolean$4,
    allowPaymentRequest: boolean$4,
    allowUserMedia: boolean$4,
    alt: null,
    as: null,
    async: boolean$4,
    autoCapitalize: null,
    autoComplete: spaceSeparated$a,
    autoFocus: boolean$4,
    autoPlay: boolean$4,
    capture: boolean$4,
    charSet: null,
    checked: boolean$4,
    cite: null,
    className: spaceSeparated$a,
    cols: number$a,
    colSpan: null,
    content: null,
    contentEditable: booleanish$8,
    controls: boolean$4,
    controlsList: spaceSeparated$a,
    coords: number$a | commaSeparated$7,
    crossOrigin: null,
    data: null,
    dateTime: null,
    decoding: null,
    ...
    dirName: null,
    disabled: boolean$4,
    download: overloadedBoolean$5,
    draggable: booleanish$8,
    encType: null,
    enterKeyHint: null,
    form: null,
    formAction: null,
    formEncType: null,
    formMethod: null,
    formNoValidate: boolean$4,
    formTarget: null,
    headers: spaceSeparated$a,
    height: number$a,
    hidden: boolean$4,
    high: number$a,
    href: null,
    hrefLang: null,
    htmlFor: spaceSeparated$a,
    httpEquiv: spaceSeparated$a,
    id: null,
    imageSizes: null,
    imageSrcSet: commaSeparated$7,
    inputMode: null,
    integrity: null,
    is: null,
    isMap: boolean$4,
    itemId: null,
    itemProp: spaceSeparated$a,
    itemRef: spaceSeparated$a,
    itemScope: boolean$4,
    itemType: spaceSeparated$a,
    kind: null,
    label: null,
    lang: null,
    language: null,
    ...
    optimum: number$a,
    pattern: null,
    ping: spaceSeparated$a,
    placeholder: null,
    playsInline: boolean$4,
    poster: null,
    preload: null,
    readOnly: boolean$4,
    referrerPolicy: null,
    rel: spaceSeparated$a,
    required: boolean$4,
    reversed: boolean$4,
    rows: number$a,
    rowSpan: number$a,
    sandbox: spaceSeparated$a,
    scope: null,
    scoped: boolean$4,
    seamless: boolean$4,
    selected: boolean$4,
    ...
    slot: null,
    span: number$a,
    spellCheck: booleanish$8,
    src: null,
    srcDoc: null,
    srcLang: null,
    srcSet: commaSeparated$7,
    start: number$a,
    step: null,
    style: null,
    tabIndex: number$a,
    ...
    autoCorrect: null,
    autoSave: null,
    disablePictureInPicture: boolean$4,
    disableRemotePlayback: boolean$4,
    prefix: null,
    property: null,
    results: number$a,
    security: null,
...
var html_1$3 = merge_1$2([xml$3, xlink$3, xmlns$3, aria$2, html$5]);

var boolean$5 = types$2.boolean;
var number$b = types$2.number;
var spaceSeparated$b = types$2.spaceSeparated;
var commaSeparated$8 = types$2.commaSeparated;
var commaOrSpaceSeparated$5 = types$2.commaOrSpaceSeparated;
var svg$4 = create_1$2({
  space: 'svg',
  attributes: {
    accentHeight: 'accent-height',
    alignmentBaseline: 'alignment-baseline',
  ...
  transform: caseSensitiveTransform_1$2,
  properties: {
    about: commaOrSpaceSeparated$5,
    ...
    k3: number$b,
    k4: number$b,
    kernelMatrix: commaOrSpaceSeparated$5,
    kernelUnitLength: null,
    keyPoints: null,
    // SEMI_COLON_SEPARATED
    keySplines: null,
    ...
    primitiveUnits: null,
    propagate: null,
    property: commaOrSpaceSeparated$5,
    r: null,
    radius: null,
    referrerPolicy: null,
    refX: null,
    refY: null,
    rel: commaOrSpaceSeparated$5,
    rev: commaOrSpaceSeparated$5,
    renderingIntent: null,
    repeatCount: null,
    repeatDur: null,
    requiredExtensions: commaOrSpaceSeparated$5,
    requiredFeatures: commaOrSpaceSeparated$5,
    requiredFonts: commaOrSpaceSeparated$5,
    requiredFormats: commaOrSpaceSeparated$5,
    resource: null,
    restart: null,
    result: null,
    rotate: null,
    ...
    string: null,
    stroke: null,
    strokeDashArray: commaOrSpaceSeparated$5,
    strokeDashOffset: null,
    strokeLineCap: null,
    strokeLineJoin: null,
    ...
    syncTolerance: null,
    syncToleranceDefault: null,
    systemLanguage: commaOrSpaceSeparated$5,
    tabIndex: number$b,
    tableValues: null,
    target: null,
    targetX: number$b,
    ...
    transformBehavior: null,
    type: null,
    typeOf: commaOrSpaceSeparated$5,
    to: null,
    transform: null,
    u1: null,
    u2: null,
...
var svg_1$3 = merge_1$2([xml$3, xlink$3, xmlns$3, aria$2, svg$4]);
...
function find$2(schema, value) {
  var normal = normalize_1$2(value);
  var prop = value;
  var Type = info$2;
  ...
  if (normal.length > 4 && normal.slice(0, 4) === data$2 && valid$2.test(value)) {
    // Attribute or property.
    if (value.charAt(4) === '-') {
...
function datasetToProperty$2(attribute) {
  ...
  return data$2 + value.charAt(0).toUpperCase() + value.slice(1);
}
...
var proto$6 = Schema$3.prototype;
proto$6.space = null;
proto$6.normal = {};
proto$6.property = {};
...
function merge$3(definitions) {
  ...
  return new schema$3(immutable.apply(null, property), immutable.apply(null, normal), space);
}

var normalize_1$3 = normalize$3;
...
var info$3 = Info$3;
var proto$7 = Info$3.prototype;
proto$7.space = null;
proto$7.attribute = null;
proto$7.property = null;
proto$7.boolean = false;
proto$7.booleanish = false;
proto$7.overloadedBoolean = false;
proto$7.number = false;
proto$7.commaSeparated = false;
proto$7.spaceSeparated = false;
proto$7.commaOrSpaceSeparated = false;
proto$7.mustUseProperty = false;
proto$7.defined = false;
...
var powers$3 = 0;
var boolean_1$3 = increment$3();
var booleanish$9 = increment$3();
var overloadedBoolean$6 = increment$3();
var number$c = increment$3();
var spaceSeparated$c = increment$3();
var commaSeparated$9 = increment$3();
var commaOrSpaceSeparated$6 = increment$3();

function increment$3() {
  return Math.pow(2, ++powers$3);
}

var types$3 = {
	boolean: boolean_1$3,
	booleanish: booleanish$9,
	overloadedBoolean: overloadedBoolean$6,
	number: number$c,
	spaceSeparated: spaceSeparated$c,
	commaSeparated: commaSeparated$9,
	commaOrSpaceSeparated: commaOrSpaceSeparated$6
};

var definedInfo$3 = DefinedInfo$3;
DefinedInfo$3.prototype = new info$3();
DefinedInfo$3.prototype.defined = true;
var checks$3 = ['boolean', 'booleanish', 'overloadedBoolean', 'number', 'commaSeparated', 'spaceSeparated', 'commaOrSpaceSeparated'];
var checksLength$3 = checks$3.length;

function DefinedInfo$3(property, attribute, mask, space) {
  var index = -1;
  var check;
  mark$3(this, 'space', space);
  info$3.call(this, property, attribute);

  while (++index < checksLength$3) {
    check = checks$3[index];
    mark$3(this, check, (mask & types$3[check]) === types$3[check]);
  }
}
...
function create$3(definition) {
  ...
  for (prop in props) {
    info = new definedInfo$3(prop, transform(attributes, prop), props[prop], space);
    ...
    property[prop] = info;
    normal[normalize_1$3(prop)] = prop;
    normal[normalize_1$3(info.attribute)] = prop;
  }

  return new schema$3(property, normal, space);
}

var xlink$4 = create_1$3({
  space: 'xlink',
...
var caseSensitiveTransform_1$3 = caseSensitiveTransform$3;

function caseSensitiveTransform$3(attributes, attribute) {
  return attribute in attributes ? attributes[attribute] : attribute;
}

var caseInsensitiveTransform_1$3 = caseInsensitiveTransform$3;

function caseInsensitiveTransform$3(attributes, property) {
  return caseSensitiveTransform_1$3(attributes, property.toLowerCase());
}

var xmlns$4 = create_1$3({
  space: 'xmlns',
  attributes: {
    xmlnsxlink: 'xmlns:xlink'
  },
  transform: caseInsensitiveTransform_1$3,
  properties: {
    xmlns: null,
    xmlnsXLink: null
  }
...
var booleanish$a = types$3.booleanish;
var number$d = types$3.number;
var spaceSeparated$d = types$3.spaceSeparated;
var aria$3 = create_1$3({
  transform: ariaTransform$3,
  properties: {
    ariaActiveDescendant: null,
    ariaAtomic: booleanish$a,
    ariaAutoComplete: null,
    ariaBusy: booleanish$a,
    ariaChecked: booleanish$a,
    ariaColCount: number$d,
    ariaColIndex: number$d,
    ariaColSpan: number$d,
    ariaControls: spaceSeparated$d,
    ariaCurrent: null,
    ariaDescribedBy: spaceSeparated$d,
    ariaDetails: null,
    ariaDisabled: booleanish$a,
    ariaDropEffect: spaceSeparated$d,
    ariaErrorMessage: null,
    ariaExpanded: booleanish$a,
    ariaFlowTo: spaceSeparated$d,
    ariaGrabbed: booleanish$a,
    ariaHasPopup: null,
    ariaHidden: booleanish$a,
    ariaInvalid: null,
    ariaKeyShortcuts: null,
    ariaLabel: null,
    ariaLabelledBy: spaceSeparated$d,
    ariaLevel: number$d,
    ariaLive: null,
    ariaModal: booleanish$a,
    ariaMultiLine: booleanish$a,
    ariaMultiSelectable: booleanish$a,
    ariaOrientation: null,
    ariaOwns: spaceSeparated$d,
    ariaPlaceholder: null,
    ariaPosInSet: number$d,
    ariaPressed: booleanish$a,
    ariaReadOnly: booleanish$a,
    ariaRelevant: null,
    ariaRequired: booleanish$a,
    ariaRoleDescription: spaceSeparated$d,
    ariaRowCount: number$d,
    ariaRowIndex: number$d,
    ariaRowSpan: number$d,
    ariaSelected: booleanish$a,
    ariaSetSize: number$d,
    ariaSort: null,
    ariaValueMax: number$d,
    ariaValueMin: number$d,
    ariaValueNow: number$d,
    ariaValueText: null,
    role: null
  }
});
...
var boolean$6 = types$3.boolean;
var overloadedBoolean$7 = types$3.overloadedBoolean;
var booleanish$b = types$3.booleanish;
var number$e = types$3.number;
var spaceSeparated$e = types$3.spaceSeparated;
var commaSeparated$a = types$3.commaSeparated;
var html$6 = create_1$3({
  space: 'html',
  attributes: {
    acceptcharset: 'accept-charset',
    classname: 'class',
  ...
  properties: {
    // Standard Properties.
    abbr: null,
    accept: commaSeparated$a,
    acceptCharset: spaceSeparated$e,
    accessKey: spaceSeparated$e,
    action: null,
    allow: null,
    allowFullScreen: boolean$6,
    allowPaymentRequest: boolean$6,
    allowUserMedia: boolean$6,
    alt: null,
    as: null,
    async: boolean$6,
    autoCapitalize: null,
    autoComplete: spaceSeparated$e,
    autoFocus: boolean$6,
    autoPlay: boolean$6,
    capture: boolean$6,
    charSet: null,
    checked: boolean$6,
    cite: null,
    className: spaceSeparated$e,
    cols: number$e,
    colSpan: null,
    content: null,
    contentEditable: booleanish$b,
    controls: boolean$6,
    controlsList: spaceSeparated$e,
    coords: number$e | commaSeparated$a,
    crossOrigin: null,
    data: null,
    dateTime: null,
    decoding: null,
    ...
    dirName: null,
    disabled: boolean$6,
    download: overloadedBoolean$7,
    draggable: booleanish$b,
    encType: null,
    enterKeyHint: null,
    form: null,
    formAction: null,
    formEncType: null,
    formMethod: null,
    formNoValidate: boolean$6,
    formTarget: null,
    headers: spaceSeparated$e,
    height: number$e,
    hidden: boolean$6,
    high: number$e,
    href: null,
    hrefLang: null,
    htmlFor: spaceSeparated$e,
    httpEquiv: spaceSeparated$e,
    id: null,
    imageSizes: null,
    imageSrcSet: commaSeparated$a,
    inputMode: null,
    integrity: null,
    is: null,
    isMap: boolean$6,
    itemId: null,
    itemProp: spaceSeparated$e,
    itemRef: spaceSeparated$e,
    itemScope: boolean$6,
    itemType: spaceSeparated$e,
    kind: null,
    label: null,
    lang: null,
    language: null,
    ...
    optimum: number$e,
    pattern: null,
    ping: spaceSeparated$e,
    placeholder: null,
    playsInline: boolean$6,
    poster: null,
    preload: null,
    readOnly: boolean$6,
    referrerPolicy: null,
    rel: spaceSeparated$e,
    required: boolean$6,
    reversed: boolean$6,
    rows: number$e,
    rowSpan: number$e,
    sandbox: spaceSeparated$e,
    scope: null,
    scoped: boolean$6,
    seamless: boolean$6,
    selected: boolean$6,
    ...
    slot: null,
    span: number$e,
    spellCheck: booleanish$b,
    src: null,
    srcDoc: null,
    srcLang: null,
    srcSet: commaSeparated$a,
    start: number$e,
    step: null,
    style: null,
    tabIndex: number$e,
    ...
    lowSrc: null,
    // `<img>`. Use a `<picture>`
    marginHeight: number$e,
    // `<body>`
    marginWidth: number$e,
    // `<body>`
    noResize: boolean$6,
    // `<frame>`
    noHref: boolean$6,
    ...
    rev: null,
    // `<link>`
    rightMargin: number$e,
    // `<body>`
    rules: null,
    // `<table>`
    scheme: null,
    // `<meta>`
    scrolling: booleanish$b,
    // `<frame>`. Use overflow in the child context
    standby: null,
    // `<object>`
    summary: null,
    ...
    autoCorrect: null,
    autoSave: null,
    disablePictureInPicture: boolean$6,
    disableRemotePlayback: boolean$6,
    prefix: null,
    property: null,
    results: number$e,
    security: null,
...
var html_1$4 = merge_1$3([xml$4, xlink$4, xmlns$4, aria$3, html$6]);

var boolean$7 = types$3.boolean;
var number$f = types$3.number;
var spaceSeparated$f = types$3.spaceSeparated;
var commaSeparated$b = types$3.commaSeparated;
var commaOrSpaceSeparated$7 = types$3.commaOrSpaceSeparated;
var svg$5 = create_1$3({
  space: 'svg',
  attributes: {
    accentHeight: 'accent-height',
    alignmentBaseline: 'alignment-baseline',
  ...
  transform: caseSensitiveTransform_1$3,
  properties: {
    about: commaOrSpaceSeparated$7,
    accentHeight: number$f,
    accumulate: null,
    additive: null,
    alignmentBaseline: null,
    alphabetic: number$f,
    ...
    hrefLang: null,
    horizAdvX: number$f,
    horizOriginX: number$f,
    horizOriginY: number$f,
    id: null,
    ideographic: number$f,
    imageRendering: null,
    initialVisibility: null,
    in: null,
    in2: null,
    ...
    k3: number$f,
    k4: number$f,
    kernelMatrix: commaOrSpaceSeparated$7,
    kernelUnitLength: null,
    keyPoints: null,
    // SEMI_COLON_SEPARATED
    keySplines: null,
    ...
    overflow: null,
    overlay: null,
    overlinePosition: number$f,
    overlineThickness: number$f,
    paintOrder: null,
    panose1: null,
    path: null,
    pathLength: number$f,
    ...
    primitiveUnits: null,
    propagate: null,
    property: commaOrSpaceSeparated$7,
    r: null,
    radius: null,
    referrerPolicy: null,
    refX: null,
    refY: null,
    rel: commaOrSpaceSeparated$7,
    rev: commaOrSpaceSeparated$7,
    renderingIntent: null,
    repeatCount: null,
    repeatDur: null,
    requiredExtensions: commaOrSpaceSeparated$7,
    requiredFeatures: commaOrSpaceSeparated$7,
    requiredFonts: commaOrSpaceSeparated$7,
    requiredFormats: commaOrSpaceSeparated$7,
    resource: null,
    restart: null,
    result: null,
    rotate: null,
    ...
    slope: null,
    snapshotTime: null,
    specularConstant: number$f,
    specularExponent: number$f,
    spreadMethod: null,
    spacing: null,
    startOffset: null,
    stdDeviation: null,
    ...
    stopColor: null,
    stopOpacity: null,
    strikethroughPosition: number$f,
    strikethroughThickness: number$f,
    string: null,
    stroke: null,
    strokeDashArray: commaOrSpaceSeparated$7,
    strokeDashOffset: null,
    strokeLineCap: null,
    strokeLineJoin: null,
    strokeMiterLimit: number$f,
    strokeOpacity: number$f,
    strokeWidth: null,
    style: null,
    surfaceScale: number$f,
    syncBehavior: null,
    syncBehaviorDefault: null,
    syncMaster: null,
    syncTolerance: null,
    syncToleranceDefault: null,
    systemLanguage: commaOrSpaceSeparated$7,
    tabIndex: number$f,
    tableValues: null,
    target: null,
    targetX: number$f,
    ...
    transformBehavior: null,
    type: null,
    typeOf: commaOrSpaceSeparated$7,
    to: null,
    transform: null,
    u1: null,
    u2: null,
    underlinePosition: number$f,
    underlineThickness: number$f,
    unicode: null,
    unicodeBidi: null,
    unicodeRange: null,
    unitsPerEm: number$f,
    values: null,
    vAlphabetic: number$f,
    vMathematical: number$f,
    vectorEffect: null,
    vHanging: number$f,
    vIdeographic: number$f,
    version: null,
    vertAdvY: number$f,
    vertOriginX: number$f,
    vertOriginY: number$f,
    viewBox: null,
    viewTarget: null,
    visibility: null,
    width: null,
...
var svg_1$4 = merge_1$3([xml$4, xlink$4, xmlns$4, aria$3, svg$5]);
...
function find$3(schema, value) {
  var normal = normalize_1$3(value);
  var prop = value;
  var Type = info$3;
  ...
  if (normal.length > 4 && normal.slice(0, 4) === data$3 && valid$3.test(value)) {
    // Attribute or property.
    if (value.charAt(4) === '-') {
...
function datasetToProperty$3(attribute) {
  ...
  return data$3 + value.charAt(0).toUpperCase() + value.slice(1);
}
...
var hastToReact$2 = entry.getCjsExportFromNamespace(hastToReact$1);
...
function wrapper$1(h, node, options) {
  ...
  return toH(h, node, {
    schema: settings.space === 'svg' ? svg_1$4 : html_1$4,
    prefix: prefix,
    key: 0,
    react: r,
    vue: v,
...
function transform$2(tree, space) {
  return one(tree, space === 'svg' ? svg_1$3 : html_1$3);
}
...
var voids = entry.getCjsExportFromNamespace(htmlVoidElements);
...
var entities = entry.getCjsExportFromNamespace(characterEntitiesHtml4);

var legacy = entry.getCjsExportFromNamespace(characterEntitiesLegacy);

var dangerous$2 = entry.getCjsExportFromNamespace(dangerous$1);
...
function toNamed(name, next, omit, attribute) {
  ...
  if (omit && own$6.call(legacy, name) && dangerous$2.indexOf(name) === -1 && (!attribute || next && next !== equalsTo && !isAlphanumerical(next))) {
    return value;
  }
...
var _default = (0, helperPluginUtils__default.declare)(api => {
  api.assertVersion(7);
  return {
    name: "syntax-jsx",
...
function createMdxAstCompiler(options) {
  ...
  const fn = unified().use(remarkParse, options).use(remarkMdx, options).use(remarkMdxjs, options).use(remarkFootnotes, options).use(remarkSqueezeParagraphs, options);
    ...
    visitor: {
      ...
      FunctionDeclaration(path) {
        if (path.node.id.name == `MDXContent`) {
          exportsToMove = _.uniqBy(exportsToMove, e => e.declarations[0].id.name);
...
const u$1 = unified().use(remarkParse).use(remarkStringify).use(remarkMdx).use(remarkMdxjs);
...
async function resolveRecipe(pathOrUrl, projectRoot) {
  ...
  if (isUrl(pathOrUrl)) {
    const res = await fetch$1(pathOrUrl);
  ...
  if (isRelative(pathOrUrl)) {
    ...
    const res = await fetch$1(url.endsWith(`.mdx`) ? url : url + `.mdx`);
  ...
  const src = await fs$1.readFile(recipePath, `utf8`);
  return src;
}

const debug$1 = debugCtor(`recipes-machine`);
const recipeMachine = xstate.Machine({
  ...
  actions: {
    ...
    addResourcesToContext: xstate.assign((context, event) => {
      if (_.isArray(event.data) && event.data.length > 0) {
...
var typeDictionary = /*#__PURE__*/Object.freeze({
  __proto__: null,
  object: TypeDictionary.GraphQLObjectType,
  string: TypeDictionary.GraphQLString,
  guid: TypeDictionary.GraphQLID,
  integer: TypeDictionary.GraphQLInt,
  number: TypeDictionary.GraphQLFloat,
  array: TypeDictionary.GraphQLList,
  boolean: TypeDictionary.GraphQLBoolean,
  required: TypeDictionary.GraphQLNonNull,
  'enum': TypeDictionary.GraphQLEnumType
});
...
function joiToGraphql(constructor) {
  ...
  if (lazyLoadQueue.length) {
    target = new TypeDictionary.GraphQLObjectType({
      name,
      description,
      fields: function () {
...
internals.setType = schema => {
  ...
  if (schema._tests.length) {
    if (schema._flags.presence) {
      return {
        type: new TypeDictionary.GraphQLNonNull(typeDictionary[schema._tests[0].name])
      };
    }
  ...
  if (schema._flags.presence === `required`) {
    return {
      type: new TypeDictionary.GraphQLNonNull(typeDictionary[schema._type])
    };
  }
  ...
  if (schema._flags.allowOnly) {
    ...
    return {
      type: new TypeDictionary.GraphQLEnumType(config)
    };
  }
  ...
  for (let i = 0; i < fields.length; ++i) {
    ...
    if (field.schema._type === `object`) {
      ...
      if (!field.schema._inner.children) {
        ...
        Type = new TypeDictionary.GraphQLObjectType({
    ...
    if (field.schema._type === `array`) {
      ...
      if (Hoek.reach(field, pathToMethod)) {
        ...
        if (Hoek.reach(field, `schema._inner.items.0._type`) === `object`) {
          const {
            name
          } = Hoek.reach(field, `schema._inner.items.0._meta.0`);
          const Item = new TypeDictionary.GraphQLObjectType({
            name,
            fields: internals.buildFields(field.schema._inner.items[0]._inner.children)
          });
          Type = new TypeDictionary.GraphQLList(Item);
        } else {
          Type = new TypeDictionary.GraphQLList(typeDictionary[field.schema._inner.items[0]._type]);
        }
      }
...
internals.buildArgs = args => {
  ...
  for (const key in args) {
    if (args[key]._type === `object`) {
      argAttrs[key] = {
        type: new TypeDictionary.GraphQLInputObjectType({
...
const internals$2 = {};
internals$2.inputSchema = Joi.object().keys({
  query: Joi.object(),
  mutation: Joi.object(),
  subscription: Joi.object()
});

internals$2.buildFields = obj => {
  const attrs = {};
...
function createTypes() {
  const resourceTypes = Object.entries(resources).map(([resourceName, resource]) => {
    ...
    const queryType = {
      ...
      args: {
        id: {
          type: TypeDictionary.GraphQLString
        }
      },
    ...
    if (resource.all) {
      ...
      const ConnectionType = new TypeDictionary.GraphQLObjectType({
        name: connectionTypeName,
        fields: {
          nodes: {
            type: new TypeDictionary.GraphQLList(type)
          }
        }
      });
  ...
  const queryTypes = _.flatten(resourceTypes.filter(Boolean).map(r => r.query)).reduce((acc, curr) => {
    const typeName = typeNameToHumanName(curr.type.toString());
    acc[typeName] = curr;
    return acc;
  }, {});

  const mutationTypes = _.flatten(resourceTypes.filter(Boolean).map(r => r.mutation)).reduce((acc, curr) => {
...
dotenv.config(); // Create a session id — mostly useful to tell the client when the server
// has restarted
...
const compareState = (oldState, newState) => {
  ...
  const comparison = !_.isEqual(newState, oldState) || lastDone !== newDone;
  lastDone = newDone;
  return comparison;
};
...
const OperationType = new TypeDictionary.GraphQLObjectType({
  name: `Operation`,
  fields: {
    state: {
      type: TypeDictionary.GraphQLString
...
const rootQueryType = new TypeDictionary.GraphQLObjectType({
  name: `Root`,
  fields: () => queryTypes
});
const rootMutationType = new TypeDictionary.GraphQLObjectType({
  name: `Mutation`,
  fields: () => {
    return { ...mutationTypes,
      createOperation: {
        ...
        args: {
          ...
          watchChanges: {
            type: TypeDictionary.GraphQLBoolean
          }
        },
        resolve: (_data, args) => {
...
const rootSubscriptionType = new TypeDictionary.GraphQLObjectType({
  name: `Subscription`,
  fields: () => {
    return {
      operation: {
...
const schema$4 = new TypeDictionary.GraphQLSchema({
  query: rootQueryType,
...
server.listen(PORT, () => {
  new entry.dist.SubscriptionServer({
    execute: TypeDictionary.execute,
    subscribe: TypeDictionary.subscribe,
    schema: schema$4
  }, {
    server,
    path: `/graphql`
