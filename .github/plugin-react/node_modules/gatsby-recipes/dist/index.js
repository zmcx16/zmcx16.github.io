...
function u$1(a) {
  ...
  if (!(b = Object.keys(a).sort()).length && a.constructor && a.constructor !== Object) {
    return b = t$1.get(a) || Math.random().toString(36).slice(2), t$1.set(a, b), '{"__key":"' + b + '"}';
  }
  ...
  for (e = b.length; d < e; d++) {
    (g = u$1(a[f = b[d]])) && (1 < c.length && (c += ","), c += u$1(f) + ":" + g);
  }
...
function makeFetchURL(a, b) {
  ...
  b.variables && a.push("variables=" + encodeURIComponent(v$1(b.variables)));
  b.extensions && a.push("extensions=" + encodeURIComponent(v$1(b.extensions)));
  return c + "?" + a.join("&");
}
...
function createRequest(a, b) {
  if ("string" == typeof a) {
    var c = w(a);
    a = void 0 !== x$1[c] ? x$1[c] : parse(a, {
      noLocation: !0
    });
  } else {
    void 0 !== a.__key ? c = a.__key : (c = w(entry.print(a)), a = void 0 !== x$1[c] ? x$1[c] : a);
  }
...
n = function (a) {
  ...
  b.prototype.toString = m$1;
  return b;
}(Error);

r$1 = new Set(), t$1 = new WeakMap();
x$1 = Object.create(null);
...
function p$1(a, b) {
  ...
  if (Array.isArray(a)) {
    ...
    for (var d in a) {
      "__typename" === d && "string" == typeof a[d] ? b.push(a[d]) : p$1(a[d], b);
    }
  }
...
function t$2(a) {
  if (a.selectionSet && !a.selectionSet.selections.some(r$2)) {
    return h({}, a, {
...
function A$1(a, b) {
  return z$2(a.kind, a, h({}, a.context, {
...
function J$1(a) {
  ...
  function c(a) {
    ...
    "cache-and-network" === a.context.requestPolicy && (b.stale = !0, K$1(l, a));
    return b;
  }
  ...
  g = function L(a, b, c, d) {
    ...
    return function (a) {
      ...
      var l = new Set(),
          k = a.operation.context.additionalTypenames;
      k = p$1(a.data).filter(q$1).concat(k || []);
  ...
  }(f, a, l), m = function M(a, b) {
    return function (c) {
      var d = c.operation,
          e = c.data,
          h = d.context.additionalTypenames;
      null != e && (a.set(d.key, {
        operation: d,
        data: e,
        error: c.error
      }), p$1(c.data).filter(q$1).concat(h || []).forEach(function (a) {
  ...
  return function (a) {
    ...
    b = H(e)(n(filter$1(G)(map$1(H$1)(merge$1([map$1(F)(filter$1(h$1)(b)), filter$1(I)(b)])))));
    return merge$1([a, b]);
  };
}

function K$1(a, b) {
  return a.reexecuteOperation(z$2(b.kind, b, h({}, b.context, {
    ...
    a = D(function (a) {
      var b = a.key,
        ...
        return "teardown" === a.kind && a.key === b;
          ...
          f = makeFetchBody(a),
          g = makeFetchURL(a, f),
          m = makeFetchOptions(a, f);
      return H(function (b) {
        var d = b.data ? void 0 : b.error;
      })(takeUntil$1(e)(makeFetchSource(a, g, m)));
    })(filter$1(Q)(d));
    h = b(filter$1(R)(d));
    return merge$1([a, h]);
  };
  ...
  return function (a) {
    function d(a) {
      ...
      return make$1(function (c) {
        ...
        function g() {
          k || (k = !0, "subscription" === a.kind && l.reexecuteOperation(z$2("teardown", a, a.context)), h());
        }
...
Y.prototype.executeRequestOperation = function (a) {
  ...
  h = filter$1(function (b) {
    return "teardown" === b.kind && b.key === a.key;
  })(this.operations$), n = onEnd$1(function () {
    d.onOperationEnd(a);
  })(onStart$1(function () {
  ...
  return "query" === a.kind && a.context.pollInterval ? K(function c() {
    return n;
  })(merge$1([fromValue$1(0), interval$1(a.context.pollInterval)])) : n;
};
...
function useSource(input, transform) {
  function _ref2(value) {
    if (!currentInit) {
      setState(function _ref(prevValue) {
  ...
  var ref = entry.react.useMemo(function () {
    var subject = makeSubject$1(),
        source = concat$1([fromValue$1(input), subject.source]),
    ...
    N(function (value) {
      state = value;
    })(transform(fromValue$1(input))).unsubscribe();
    currentInit = !1;
    return state;
  }),
      state = ref$1[0],
      setState = ref$1[1];
  entry.react.useEffect(function () {
    return N(_ref2)(transform(input$, state)).unsubscribe;
  }, [input$]);
...
function useSubscription(args, handler) {
  ...
  state = (ref = useSource(subscription$ = entry.react.useMemo(function () {
    ...
    return scan$1(_ref, prevState || initialState)(K(_ref3$1)(subscription$$));
  }, [])))[0];
...
var defaultClient, Context, Provider, Consumer, useClient, initialState, currentInit, isShallowDifferent;
...
var cli = (async ({
  ...
  try {
    ...
    const client = createClient({
      ...
      exchanges: [...X, subscriptionExchange({
