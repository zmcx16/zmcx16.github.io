...
async function initialize({
  ...
  if (config && config.flags) {
    ...
    if (config.flags.FAST_REFRESH && process.env.GATSBY_HOT_LOADER && process.env.GATSBY_HOT_LOADER !== `fast-refresh`) {
  ...
  process.env.GATSBY_HOT_LOADER = (0, _getReactHotLoaderStrategy.getReactHotLoaderStrategy)(); // theme gatsby configs can be functions or objects
